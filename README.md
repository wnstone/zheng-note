...
蒸笔记按**两个维度**工作,合起来就是「2 种格式 × 单篇/批量」:

**① 格式 —— 按内容是"谁的"**(自动判断,判不准会先问你一句):

- **A · 观点提炼版**(默认):蒸**别人的**观点 / 外部信息(政论 / 历史 / 访谈 / 文章)。骨架 = 他在说什么 / 核心论点 / 关键论据 / 预测与判断 / 存疑处 / 对我的价值。
- **B · 人生复盘版**:蒸**你自己**第一人称的人生 / 认知 / 情绪复盘。骨架 = 讲什么 / 关键转折 / 对我的意义。

**② 数量 —— 按你给几个**:

- 给**一个文件** → 蒸一篇笔记;
- 给**一个文件夹** → 逐篇批量蒸(每个 `.md` 各蒸一张、已存在同名的跳过不覆盖)。
